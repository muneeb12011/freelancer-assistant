...
const SupportPage = () => {
  ...
  const initialFaqs = [
    {
      ...
      answer:
        "Go to the 'Privacy' section in settings and click 'Change Password.'",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
      ...
      answer:
        "Fill out the form below or email us at support@freelancersassistant.com.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can enter your ticket ID below or search for your ticket.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
      ...
      answer:
        "You can update your billing info from the Account Settings under 'Billing'.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
      ...
      answer:
        "Navigate to the 'Profile' section and select 'Edit Email' to update your email.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
      ...
      answer:
        "Please refer to our Refund Policy page for detailed information regarding refunds.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
    {
      ...
      answer:
        "Visit the Updates section in your account to download the latest version.",
      helpfulCount: 0,
      notHelpfulCount: 0,
    },
  ];
  ...
  // Modal for live agent chat request
  const [showAgentChatModal, setShowAgentChatModal] = useState(false);

  // Modal for Contact Options (Email / WhatsApp)
  const [showContactOptions, setShowContactOptions] = useState(false);

  // Scroll-to-top visibility
  const [showScrollTop, setShowScrollTop] = useState(false);

  // Ref for Contact Support form (for scrolling)
  ...
  // -------------------------------
  // Handle file selection for contact form
  // -------------------------------
  ...
  // -------------------------------
  // Handle "Request Live Agent" (simulate modal)
  // -------------------------------
  ...
  // -------------------------------
  // Handle Contact Options Modal (Email / WhatsApp)
  // -------------------------------
  ...
  const handleEmailSupport = () => {
    window.location.href = "mailto:muneeb.fullstack.dev46@gmail.com";
  };
    ...
    <div class="support-page">
      ...
      <div className="mb-10">
        ...
        <button
          ...
          className="mt-4 btn-blue full-width"
        >
      ...
      <div ref={contactFormRef} className="bg-gray-800 p-6 rounded-lg mb-6">
        ...
        <button
          ...
          className="mt-4 full-width btn-purple"
        >
          Share Support Page
        </button>
      </div>
      ...
      <div className="bg-gray-800 p-6 rounded-lg mb-6">
        ...
        >
          {chatHistory.map((chat, index) => (
            ...
            >
              <p
                className={`${chat.sender === "user" ? "text-blue-400" : "text-gray-300"
                  }`}
              >
                {chat.text}
              </p>
        ...
        <form onSubmit={handleChatSubmit} className="flex">
          ...
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-700 p-2 rounded-r font-medium"
            disabled={loading}
          >
            Send
          </button>
        ...
        >
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              className="w-full btn-blue mb-2"
            >
              Email Support
            </button>
            <button
              onClick={handleWhatsAppSupport}
              className="w-full btn-green mb-2"
            >
              WhatsApp Support
            </button>
            <button
